    ...
    return Scaffold(
        body: Center(child: Padding(
          ...
          child: Card(clipBehavior: Clip.antiAlias,elevation: 10,
            child: Container(height: height*600,width: width*400,
            child: Column(children: <Widget>[SizedBox(height: height*10,),
              Container(height: height*70, child: Center(child: Image(image: AssetImage("assets/Sign up.png"),fit: BoxFit.fitHeight,),),),
      ...
      child: Column(children: <Widget>[
          ...
          Expanded(
                  child: Padding(
                    ...
                    child: TabBarView(
                    children: [
                      FormSign("USER SIGNUP"),
                       FormSign("CHANNEL PARTNER SIGNUP"),
                      FormSign("SALES ASSOCIATE SIGNUP"),
                    ],
                ),
                  ),
          ),
    ...
    return Column(children: <Widget>[
      SizedBox(height: 20,),
                    ...
                    decoration: InputDecoration(
                          ...
                          Padding(
                            padding: const EdgeInsets.all(10.0),
                            child: Container(height: width*10,width: width*10,child: Icon(Icons.phone,color: Colors.orangeAccent,),),
                          )
                        ],
                      ),
                      ),
                    ...
                    decoration: InputDecoration(
                          ...
                          Padding(
                            padding: const EdgeInsets.all(10.0),
                            child: Container(height: width*10,width: width*10,child: Icon(Icons.mail,color: Colors.orangeAccent,),),
                          )
                        ],
                      ),
                      ),
